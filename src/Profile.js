              ...
              <form>
                    ...
                    <div className="position-relative">
                      <PhoneInput
                        ...
                        inputClass={`form-control ${
                          ...
                          editedData.phoneNumber ? "is-valid" : ""
                        }`}
                      />
                      {phoneError && <div className="invalid-feedback">{phoneError}</div>}
                      {!phoneError && editedData.phoneNumber && (
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-control"
                    name="country"
                    value={isEditing ? editedData.country : userData.country}
                    onChange={handleChange}
                    disabled={!isEditing}
                  />
                </div>
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    value={isEditing ? editedData.education.startYear : userData.education.startYear}
                    onChange={handleChange}
                    disabled={!isEditing}
                  />
                </div>
                ...
                <div className="mb-3">
                  <div className="form-check">
                    <input
                      ...
                      checked={isEditing ? editedData.education.isOngoing : userData.education.isOngoing}
                ...
                {(isEditing ? !editedData.education.isOngoing : !userData.education.isOngoing) && (
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      value={isEditing ? editedData.education.endDate : userData.education.endDate}
                      onChange={handleChange}
                      disabled={!isEditing}
                      required
                    />
